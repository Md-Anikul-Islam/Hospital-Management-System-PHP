<?php
  ...
  include('connected.php');
   ...
   $query = mysqli_query($conn,"SELECT * FROM `doctor_info` WHERE ID='$ID'"); 
   $data = mysqli_fetch_array($query);
?>

<html>
<head>
  <title>Doctor_from</title>
...
<form action="update_data_form.php" method="post" enctype="multipart/form-data">
	   ...
	   <div class="doctor_id">				 
                     Doctor ID:
                     <p><input type="number"name="doctorid" value=<?php echo $data['DOCTOR_ID'];?> required /></p><br/>
	   </div>
